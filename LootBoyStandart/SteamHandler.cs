...
namespace LootBoyStandart
{
    ...
    {
        private SteamWeb _web;

        public SteamHandler(SteamWeb web)
        {
            _web = web;
        }
        ...
        private void AddCookies(RestRequest request)
        {
            ...
            request.AddCookie("sessionid", _web.SessionId);
            request.AddCookie("steamLoginSecure", _web.TokenSecure);
            request.AddCookie("steamLogin", _web.Token);
